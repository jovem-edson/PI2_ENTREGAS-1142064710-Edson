            ...
            <div class="container-mt-5">
                <div class="col-md-12">
                    <div class="mb-5 col-md-12">
                        <h1 class="h1 text-center text-success">No ponto certo para colher</h1>
                        <p>Seja bem-vindo(a) ao Horta Inteligente... Confira se o fruto analisado está maduro</p>
                    </div>
                    
                    <div class="col-md-12">
                        <h5 class="text-success">Últimas frutas adicionadas:</h5>
            <%
                try {
                    //conexão com o BD
                    Connection conecta;
                    ...
                    //Listando os dados
                    st = conecta.prepareStatement("SELECT * FROM fruta ORDER BY codigo DESC LIMIT 5");
